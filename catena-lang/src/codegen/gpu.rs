...
fn render_primitive_assignment(
    ...
    match assignment.op.as_str() {
        ...
        "shape.2d" => parallel_gpu::render_shape_2d(out, assignment)?,
        "gpu.grid.2d" => parallel_gpu::render_grid_2d(out, assignment)?,
        "parallel.plan" => parallel_gpu::render_plan(out, assignment)?,
        "parallel.plan.root-types" => parallel_gpu::render_root_types(out, assignment)?,
        "parallel.schedule" => parallel_gpu::render_schedule(out, assignment)?,
